#!/bin/bash
# Миграция данных: локальный PostgreSQL → Railway
# Использование: ./scripts/migrate-to-railway.sh
...
echo ""
echo "2. Примени схему в Railway:"
echo "   cd backend && npx prisma db push"
echo ""
echo "3. Импорт данных:"
echo "   psql \"\$DIRECT_URL\" -f $BACKUP"
echo ""
echo "   (DIRECT_URL — connection string из Railway → Variables)"
