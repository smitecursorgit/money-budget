#!/bin/bash
# Миграция данных: локальный PostgreSQL → Supabase (или любой другой)
# Использование: ./scripts/migrate-to-supabase.sh
...
echo ""
echo "2. Примени схему в Supabase:"
echo "   cd backend && npx prisma db push"
echo ""
echo "3. Импорт данных:"
echo "   psql \"\$DIRECT_URL\" -f $BACKUP"
echo ""
echo "   (DIRECT_URL — direct connection из Supabase Dashboard)"
